...
export async function sendOtpCode(input: {
  ...
  const subject = "Your FinEdge OTP Code";
  const text = `Your FinEdge OTP code is ${input.code}. It expires in 10 minutes. If you did not request this, ignore this email.`;
  const html = `
